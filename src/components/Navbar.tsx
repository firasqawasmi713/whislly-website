  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-[#030716]/95 backdrop-blur-md border-b border-blue-900/40 py-3 shadow-2xl shadow-black/70'
          : 'bg-transparent py-4 border-b border-slate-800/20'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a
            href="#"
            className="group flex items-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-sm"
          >
            <img 
              src="/logo.png" 
            ...
            />
            <span className="font-display tracking-tight text-2xl font-bold text-white group-hover:text-blue-400 transition-colors">
              {AGENCY_INFO.name}
            </span>
          </a>
